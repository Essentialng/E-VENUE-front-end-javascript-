...
export var AddPosts = function (_a) {
    ...
    var _e = useState(false), showLoginErr = _e[0], setShowLoginErr = _e[1];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, addPostFn({ formDataBody: formDataBody, setErrMsg: setErrMsg })];
                    case 2:
                        res = _a.sent();
    ...
    return (_jsxs("div", __assign({ className: styles.container64H }, { children: [_jsxs("section", { children: [_jsxs("form", __assign({ onSubmit: handleSubmit }, { children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "post" }), _jsx("input", { type: "text", name: "post", id: "post", placeholder: "Write Something...", onChange: function (e) { return handleInputChange(e, setFormDetails); }, value: formDetails.post, required: true, "aria-required": true })] }), _jsxs("div", { children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "imgs" }), _jsx("input", { type: "file", name: "imgs", id: "imgs", onChange: function (e) { return handleInputChange(e, setFormDetails); }, multiple: true })] }), _jsxs("div", { children: [" ", _jsx("button", { children: "Post" })] })] })] })), showLoginErr && _jsx(LoginNotice, {})] }), errMsg && _jsx(InlineErrMsg, { errMsg: errMsg }), successMsg && _jsx(InlineSuccessMsg, { successMsg: successMsg })] })));
};

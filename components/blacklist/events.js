...
export var BlacklistEvents = function () {
    var _a = useState(), events = _a[0], setEvents = _a[1];
    var _b = useState(""), errMsg = _b[0], setErrMsg = _b[1];
    useEffect(function () {
        getLimitedInfoFn({ blacklistIdentifier: "blacklistIdentifier", setErrMsg: setErrMsg })
            .then(function (res) {
            setEvents(res);
            setErrMsg("");
        })
    ...
    //   ));
    return (_jsxs("div", __assign({ className: styles.containerDE7, style: { padding: "2rem" } }, { children: [_jsx("div", __assign({ className: styles.header }, { children: _jsx("h1", { children: "Blacklisted Events" }) })), errMsg ? (_jsx(_Fragment, { children: _jsx(ErrMsg, { errMsg: errMsg }) })) : (_jsx("div", __assign({ className: styles.contentAreaDE7 }, { children: content })))] })));
};

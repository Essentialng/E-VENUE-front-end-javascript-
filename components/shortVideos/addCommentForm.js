...
export var AddCommentForm = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, addCommentFn({ video_id: video_id, comment: comment, setErrMsg: setErrMsg })];
                    case 2:
                        res = _a.sent();
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("form", __assign({ onSubmit: handleSubmit, className: styles.formCBA }, { children: [_jsx("input", { type: "text", placeholder: "Add a comment", name: "comment", onChange: function (e) { return setComment(e.target.value); }, value: comment }), _jsx("button", __assign({ type: "submit" }, { children: "Comment" }))] })), errMsg && _jsx(InlineErrMsg, { errMsg: errMsg }), successMsg && _jsx(InlineSuccessMsg, { successMsg: successMsg })] }));
};

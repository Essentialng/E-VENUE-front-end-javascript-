...
export var TopEvents = function () {
    ...
    useEffect(function () {
        getLimitedInfoFn({ topEventsIdentifier: "topEventsIdentifier", setErrMsg: setErrMsg })
            .then(function (res) {
            setEvents(res);
            setErrMsg("");
        })
    ...
    return (_jsxs("div", __assign({ className: styles.upcomingLL2 }, { children: [_jsx("h1", { children: "Top Events" }), errMsg ? _jsx("p", { children: errMsg }) : _jsx(Slider, { content: content || [] })] })));
};

...
export var ShortVideoUploadForm = function () {
    var _a = useState({
        video: "",
        description: "",
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, uploadShortVideoFn({ formDataBody: formDataBody, setErrMsg: setErrMsg })];
                    case 2:
                        res = _a.sent();
                        if (res === null || res === void 0 ? void 0 : res.message.includes("successfully")) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("form", __assign({ onSubmit: handleSubmit, className: styles.form9XW }, { children: [_jsx("h1", { children: "Upload Short Video" }), _jsxs("div", { children: [_jsx("label", { htmlFor: "video" }), _jsx("input", { type: "file", name: "video", id: "video", accept: "video/mp4, video/webm", onChange: function (e) { return handleInputChange(e, setFormDetails); }, required: true, "aria-required": true })] }), _jsxs("div", { children: [_jsx("label", __assign({ htmlFor: "description" }, { children: "Description" })), _jsx("textarea", { name: "description", id: "description", value: formDetails.description, required: true, "aria-required": true, onChange: function (e) { return handleInputChange(e, setFormDetails); } })] }), _jsx("button", { children: "Post" })] })), errMsg && _jsx(InlineErrMsg, { errMsg: errMsg }), successMsg && _jsx(InlineSuccessMsg, { successMsg: successMsg })] }));
};
